...
public class HPlayerDao {
	...
	private RowMapper<HPlayer> rowMapper = BeanPropertyRowMapper.newInstance(HPlayer.class);

		
	
	//insert를 위한 것.
	public HPlayerDao(DataSource dataSource) {
...
//	
	...
	public List<HPlayer> getHPlayers(HPlayer player){
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("hname", player.getHname());
		return jdbc.query(HPlayerDaoSqls.SELECT_Hname, map, rowMapper);
	}
	
	public List<HPlayer> getHnameOnly(HPlayer hplayer){
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("hname", hplayer.getHname());
		return jdbc.query(HPlayerDaoSqls.SELECT_OnlyName, map, rowMapper);
	}
}
