...
public class PPlayerDaoSqls {
	public static final String SELECT_Pname = "SELECT * FROM (select d.name as pname, d.team, psc.p_position, psc.era, psc.inning, psc.win, psc.lose, psc.save, psc.hold, psc.stamina, psc.st_rank, psc.b_speed, psc.sp_rank, psc.b_power, psc.p_rank, psc.command, psc.c_rank, psc.e_control, psc.mind, psc.p_style, psc.t_gofo, psc.mainball" + 
			...
			"	on d.num = psc.Num) as subquery where pname =:pname";
	
	public static final String SELECT_OnlyName = "select pname from pstat_classic";
}
