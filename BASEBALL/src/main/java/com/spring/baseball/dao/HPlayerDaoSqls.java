...
public class HPlayerDaoSqls {
	//:hname -> 맵핑에서 지정한 변수
	public static final String SELECT_Hname = "SELECT * FROM (select" + 
			...
			" on h.num = d.num) ss" + 
			" on c.num = ss.num) as subquery where hname = :hname";
	
	public static final String SELECT_OnlyName = "SELECT hname from hstat_classic";
